// copied from https://github.com/datopian/ckanext-blob-storage/blob/29b271fd08569956d5837e08cdda058c524c79e7/ckanext/external_storage/fanstatic/js/upload.js
  ...
  return {
    ...
    _saveResource: function () {
      ...
      this._generateAuthToken(scopes)
        ...
        .catch(
          // Updated by fjelltopp:
          // since this file was created the ckanUploader (ckan3-js-sdk) lib has a bug
          // parsing the varify resource endpoint after crearting a new resource upload.
          // Adding single retry fixes it as the file now exists in blob storage
